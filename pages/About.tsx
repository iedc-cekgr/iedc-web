  ...
  return (
    <div className="pt-40 px-6 max-w-7xl mx-auto space-y-32 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <GlassCard className="p-12 bg-[#FFDE03] border-black dark:border-white shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] dark:shadow-[16px_16px_0px_0px_rgba(255,255,255,1)]">
        ...
        <GlassCard className="p-12 bg-[#00FFFF] border-black dark:border-white shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] dark:shadow-[16px_16px_0px_0px_rgba(255,255,255,1)]">
      ...
      <div className="space-y-16">
        <div className="p-12 border-[4px] border-black dark:border-white bg-black dark:bg-white text-white dark:text-black shadow-[12px_12px_0px_0px_rgba(255,0,255,1)]">

...
import { LogOut, LayoutDashboard, Calendar, Users, Image as ImageIcon, Database, History, Zap, Trophy, Radio, Lightbulb, UserPlus } from 'lucide-react';
      ...
      <div className="w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-700 flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2">
          {[
            ...
            { id: 'freshers', label: 'Freshers Reg.', icon: UserPlus },
          ].map((item) => (
            <button
              key={item.id}
